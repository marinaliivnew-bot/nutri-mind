...
Модель: актуальная модель Claude (например, `claude-opus-4-8` для качества черновика или `claude-sonnet-4-6` для баланса цены/скорости); вызов через серверный Anthropic SDK с ключом в секретах Edge Function.
